...
def main():
    ...
    parser.add_argument("--roberta_model_dir", type=str, default="./model/roberta-base",
    ...
    parser.add_argument("--s_topk",
                        default=0,
                        type=int,
                        help="Top-K sparse cross-modal connections per text node (0 disables).")
